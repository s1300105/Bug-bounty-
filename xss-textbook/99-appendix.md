...
### 補足資料（ロードマップの注記で言及されたもの）

- （日本語）GMOサイバーセキュリティ byイエラエ「IERAE JOURNAL」ハブ（日本語リサーチの入口）— https://gmo-cybersecurity.com/blog/blog_category/ierae-journal/
- JSONBee（CSPバイパス用 JSONP エンドポイント集。※アーカイブ/移設の可能性があり利用前に要確認）— https://github.com/zigoo0/JSONBee
