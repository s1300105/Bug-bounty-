...
<!-- terms: 難読化, ミニファイ, 難読化解除, de4js, パッカー, JSFuck, JJencode, AAencode, エソテリックエンコード, UserScript, JS Nice, Jekyll, webcrack, wakaru, Restringer, Synchrony, humanify, JsDeObsBench, AST, Babel, recast, astexplorer, concolic実行, ソースマップ, unwebpack-sourcemap, sourcemapper, 制御フロー平坦化, VM型難読化, devirtualization, ディスパッチャ, DOM XSS, sink, react-native-decompiler, Hermes バイトコード, Sojson, JSjiami, CyberChef, joern, BC Detect, delta, prettydiff, stack-graphs, difftastic, CodeMirror, monaco-editor, rome -->
